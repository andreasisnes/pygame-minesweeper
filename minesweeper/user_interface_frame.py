...
class UserInterfaceFrame:
    def __init__(self, shadow=2, grey=5, white_color=(255, 255, 255), grey_color=(192, 192, 192), dark_grey_color=(128, 128, 128)):
    ...
    def draw_white(self, screen, w, h):
        ...
        screen.fill(self._white_color, rect=(w - offset, offset, self._shadow, h - offset * 2 + self._shadow))
    ...
    def draw_grey(self, screen, w, h):
        ...
        screen.fill(self._grey_color, rect=(self._shadow, self._shadow, w, self._shadow))


    def draw_dark_grey(self, screen, w, h):
        offset = self._shadow + self._grey
        screen.fill(self._dark_grey_color, rect=(offset, offset, self._shadow, h - offset * 2))
        screen.fill(self._dark_grey_color, rect=(offset, offset, w - offset * 2, self._shadow))
    ...
    def draw(self, screen, board_size):
        ...
        screen.fill(self._white_color, rect=(self.offset, board_size, w - self.offset * 2, self._shadow))
        screen.fill(self._grey_color, rect=(self._shadow, board_size + self._shadow, w - (self._shadow * 2), self._grey))
        screen.fill(self._dark_grey_color, rect=(self.offset, board_size + self._shadow + self._grey, w - self.offset * 2, self._shadow))
