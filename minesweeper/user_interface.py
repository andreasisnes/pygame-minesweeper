...
class UserInterface:
    def __init__(self, rows: int, cols: int, mines: int, callback, shadow=2, grey=5, tile_sprite=sprites.TileBuilder(), score_sprite=sprites.ScoreBuilder(), face_sprite=sprites.FaceBuilder()):
        ...
        tmp = UserInterfaceBoard(self._board, tile_sprite.build(), frame.offset, callback)
        self._components = [
            tmp,
